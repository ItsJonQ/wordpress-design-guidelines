	...
	render() {
		...
		switch ( icon ) {
			...
			case 'buddicons-bbpress-logo':
				path =
					'M4.5 6.2C3.7 7.3 3.3 8.6 3.3 10c0 1 .2 1.9.6 2.8l1-4.6c.3-1.7.4-2-.4-2zm4 6.4c.3-1.3 0-2.3-1.1-2.3-.8 0-1.6.6-1.8 1.5l-.3 1.7c-.3 1 .3 1.5 1 1.5 1.2 0 1.9-1.1 2.2-2.4zM10 2c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 15.5c-2.1 0-4-.8-5.3-2.2-.3-.4-.7-.8-1-1.2-.7-1.2-1.2-2.6-1.2-4.1 0-4.1 3.4-7.5 7.5-7.5s7.5 3.4 7.5 7.5-3.4 7.5-7.5 7.5zm3.8-4.9c.3-1.3 0-2.3-1.1-2.3-.8 0-1.6.6-1.8 1.5l-.4 1.7c-.2 1.1.4 1.6 1.1 1.6 1.1-.1 1.9-1.2 2.2-2.5zM10 3.3c-2 0-3.9.9-5.1 2.3.6-.1 1.4-.2 1.8-.3.2 0 .2.1.2.2 0 .2-1 4.8-1 4.8.5-.3 1.2-.7 1.8-.7.9 0 1.5.4 1.9.9l.5-2.4c.4-1.6.4-1.9-.4-1.9-.4 0-.4-.5 0-.6.6-.1 1.8-.2 2.3-.3.2 0 .2.1.2.2l-1 4.8c.5-.4 1.2-.7 1.9-.7 1.7 0 2.5 1.3 2.1 3-.3 1.7-2 3-3.8 3-1.3 0-2.1-.7-2.3-1.4-.7.8-1.7 1.3-2.8 1.4 1.1.7 2.4 1.1 3.7 1.1 3.7 0 6.7-3 6.7-6.7s-3-6.7-6.7-6.7z';
				break;
			...
			case 'businessman':
				path =
					'M17 16.9v-2.5c0-.7-.1-1.4-.5-2.1-.4-.7-.9-1.3-1.6-1.7-.7-.5-2.2-.6-2.9-.6l-1.6 1.7.6 1.3v3l-1 1.1L9 16v-3l.7-1.3L8 10c-.8 0-2.3.1-3 .6-.7.4-1.1 1-1.5 1.7S3 13.6 3 14.4v2.5S5.6 18 10 18s7-1.1 7-1.1zM10 2.1c-1.9 0-3 1.8-2.7 3.8.3 2 1.3 3.4 2.7 3.4s2.4-1.4 2.7-3.4c.3-2.1-.8-3.8-2.7-3.8z';
				break;
			case 'businessperson':
				path =
					'M13.2 10L11 13l-1-1.4L9 13l-2.2-3C3 11 3 13 3 16.9c0 0 3 1.1 6.4 1.1h1.2c3.4-.1 6.4-1.1 6.4-1.1 0-3.9 0-5.9-3.8-6.9zm-3.2.7L8.4 10l1.6 1.6 1.6-1.6-1.6.7zM10 2.1c-1.9 0-3 1.8-2.7 3.8.3 2 1.3 3.4 2.7 3.4s2.4-1.4 2.7-3.4c.3-2.1-.8-3.8-2.7-3.8z';
				break;
			case 'businesswoman':
			...
			case 'camera-alt':
				path =
					'M15 4h2.94c.59 0 1.06.47 1.06 1.06v11.81c0 .59-.47 1.13-1.06 1.13H2.06C1.47 18 1 17.46 1 16.87V5.06C1 4.47 1.47 4 2.06 4H5l3-2h4zm-5 11c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z';
				break;
			case 'camera':
				path =
			...
			case 'cloud':
				path =
					'M14.9 9c0-.3.1-.6.1-1 0-2.2-1.8-4-4-4-1.6 0-2.9.9-3.6 2.2-.2-.1-.6-.2-.9-.2C5.1 6 4 7.1 4 8.5c0 .2 0 .4.1.5-1.8.3-3.1 1.7-3.1 3.5C1 14.4 2.6 16 4.5 16h10c1.9 0 3.5-1.6 3.5-3.5 0-1.8-1.3-3.3-3.1-3.5z';
				break;
			case 'code-standards':
				path =
			...
			case 'color-picker':
				path =
					'M17.76 2.24a2.55 2.55 0 0 0-3.6 0L12.36 4l-.71-.71a1 1 0 0 0-1.45 0L9.49 4a1 1 0 0 0 0 1.44l5 5a1 1 0 0 0 1.44 0l.71-.71a1 1 0 0 0 0-1.45L16 7.64l1.8-1.8a2.55 2.55 0 0 0-.04-3.6zM9.49 6.92L4.38 12c-2.16 2.16-.87 3.2-2.88 5.75l.72.72c2.55-2 3.59-.72 5.75-2.88l5.11-5.11z';
				break;
			case 'columns':
			...
			case 'edit-large':
				path =
					'M6.4 14.1l1.3 1.3 6.9-6.9-1.3-1.3-6.9 6.9zm6.3-7.5l-1.3-1.3-6.9 6.9 1.4 1.4 6.8-7zm2.1-4.7l3.3 3.3c.6.6.5 1.5 0 2l-9.9 9.9-6.9 1.4 1.4-6.9c6.2-6.3 9.5-9.6 9.9-9.9.6-.4 1.6-.4 2.2.2z';
				break;
			case 'edit':
				path =
			...
			case 'editor-ltr':
				path =
					'M13 2H5.5C3 2 1 4 1 6.5S3 11 5.5 11H6v6c0 .5.5 1 1 1s1-.5 1-1V5c0-.5.5-1 1-1s1 .5 1 1v12c0 .5.5 1 1 1s1-.5 1-1V4h1c.5 0 1-.5 1-1s-.5-1-1-1zm1 4v8l5-4-5-4z';
				break;
			case 'editor-ol-rtl':
				path =
					'M15 8.8c.1-.1.3-.1.4-.1.1 0 .3 0 .4.1.1.1.2.2.2.3 0 .1 0 .2-.1.3 0 .1-.1.2-.2.3l-.6.6-1 1v.7h2.8v-.7h-1.7l.5-.5.7-.7c.1-.1.2-.3.3-.5.1-.2.1-.3.1-.5s-.1-.4-.2-.6c-.1-.2-.3-.3-.4-.4-.2-.1-.4-.2-.7-.1-.2 0-.3 0-.5.1-.1 0-.3.1-.4.1-.2.1-.3.2-.5.4l.5.4c.1-.1.3-.2.4-.2zm1.7 6.5c-.2-.2-.5-.3-.7-.3.3-.1.5-.2.6-.4.2-.2.2-.4.2-.6 0-.3-.1-.6-.4-.7-.3-.2-.6-.3-1-.3-.5 0-.9.1-1.3.4l.4.6c.1-.1.3-.2.5-.2.1 0 .3-.1.4-.1.4 0 .6.2.6.5 0 .2-.1.3-.2.4-.2.1-.5.1-.7.1h-.3v.7h.3c.3 0 .5 0 .8.1.2.1.2.2.2.4s-.1.4-.2.5c-.2.1-.4.2-.6.2-.2 0-.4 0-.6-.1-.2 0-.4-.1-.5-.2v.7c.4.2.8.2 1.2.2.4 0 .9-.1 1.2-.3.3-.2.4-.6.4-.9 0-.3-.1-.5-.3-.7zM15 4.2c.1 0 .2-.1.3-.3V7h.8V3h-.7l-1.3 1 .4.5.5-.3zM4 6h9V5H4v1zm0 5h9v-1H4v1zm0 5h9v-1H4v1z';
				break;
			case 'editor-ol':
				path =
			...
			case 'editor-rtl':
				path =
					'M13 2H5.5C3 2 1 4 1 6.5S3 11 5.5 11H6v6c0 .5.5 1 1 1s1-.5 1-1V5c0-.5.5-1 1-1s1 .5 1 1v12c0 .5.5 1 1 1s1-.5 1-1V4h1c.5 0 1-.5 1-1s-.5-1-1-1zm1 8l5 4V6l-5 4z';
				break;
			...
			case 'email-alt2':
				path =
					'M16 1.1L4 5.9c-1.1.4-2 1.8-2 3v8.7c0 1.2.9 1.8 2 1.4l12-4.8c1.1-.4 2-1.8 2-3V2.5c0-1.2-.9-1.8-2-1.4zm.6 2.6l-6 9.3-6.7-4.5c-.1-.1-.4-.4-.2-.7.2-.4.7-.2.7-.2l6.3 2.3s4.8-6.3 5.1-6.7c.1-.2.4-.3.7-.1.3.2.2.5.1.6z';
				break;
			case 'email':
				path =
			...
			case 'lock-duplicate':
				path =
					'M15 9h-1V6c0-2.2-1.8-4-4-4S6 3.8 6 6v3H5c-.5 0-1 .5-1 1v7c0 .5.5 1 1 1h10c.5 0 1-.5 1-1v-7c0-.5-.5-1-1-1zm-4 7H9l.4-2.2c-.5-.2-.9-.8-.9-1.3 0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5c0 .6-.3 1.1-.9 1.3L11 16zm1-7H8V6c0-1.1.9-2 2-2s2 .9 2 2v3z';
				break;
			case 'lock':
				path =
					'M15 9h-1V6c0-2.2-1.8-4-4-4S6 3.8 6 6v3H5c-.5 0-1 .5-1 1v7c0 .5.5 1 1 1h10c.5 0 1-.5 1-1v-7c0-.5-.5-1-1-1zm-4 7H9l.4-2.2c-.5-.2-.9-.8-.9-1.3 0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5c0 .6-.3 1.1-.9 1.3L11 16zm1-7H8V6c0-1.1.9-2 2-2s2 .9 2 2v3z';
			...
			case 'remove':
				path =
					'M10 1c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7-3.1 7-7 7zM6 9v2h8V9H6z';
				break;
			case 'rest-api':
				path =
			...
			case 'twitter-alt':
				path =
					'M13.9 13.8H8.5c-.2 0-.3-.1-.3-.4v-3h5.7c1.1 0 2.1-.9 2.1-2.1 0-1.2-1-2.1-2.1-2.1H8.2V4.1C8.2 2.9 7.2 2 6 2c-1.1 0-2 .9-2 2.1v9.2C4 16 5.5 17.9 8.6 18H14c1.1 0 2.1-1 2.1-2.1-.1-1.2-1.1-2.1-2.2-2.1z';
				break;
			case 'twitter':
				path =
